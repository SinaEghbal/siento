...
% -------------------------------------------------------------------------
function currentFrame=UpdateFrameReadout(ud)
...
%current frame value: currframe, total frame value: numFrames (sazzad)
...
getCurrFrame(ud.currframe); % pass current frame number to external func
