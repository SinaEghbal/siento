function  [Performance_Measures, Performance_Measures1, ...
                ConfusionMatrix, KResults,AllResults]= confm (NLAB_OUT,label)
Label_List = unique(label); %Retrieve name of classes (unique)
...
nlabels = double(nominal(label)); %Retrieve numeric object labels from dataset
